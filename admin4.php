...
<body>
        ...
        <div class="form-container" id  = "change_admin" >
        <?php
        ...
        $sql = "SELECT  first_name, last_name, email, username, password FROM administrators WHERE username = '$username'";
       ...
       <h2>Τροποποίηση προφίλ διαχειρηστή</h2>
        <form method="POST" >
        ...
        <input type="submit" value="Τροποποίηση" name = "admin_profile" id = "admin_profile" >
...
<?php
    if(isset($_POST["admin_profile"])){
            ...
            if(strcmp( $password, $confirm_password ) !== 0){
                ...
                $sql = "UPDATE administrators  SET first_name = '$first_name', last_name = '$last_name', email = '$email', username = '$username', password =  '$password' WHERE username = '$username'";
